  ...
  return (
    <div className='min-h-screen w-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex items-center justify-center p-4 md:p-8'>
      ...
      {/* Left Side - Branding & Hero */}
        ...
        {/* Right side sign up flow */}
        <div className="w-[50%] flex flex-col justify-center items-center pb-7">
        <SignUp />
        <hr />
        <div className="text-lg text-muted-foreground">
          Already have an account? <Link href='/sign-in' className="ml-2 text-[#3FBBEB] font-semibold hover:text-[#189BFF] transition-colors text-lg underline decoration-[#3FBBEB]">Login</Link>
        </div>
